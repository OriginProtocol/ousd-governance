...
contract DelegationTest is Test {
    ...
    function setUp() public {
        ...
        // staking = new MockOGVStaking(address(ogv), EPOCH, 7 days, address(source), address(0));
        ...
        // vm.prank(oak);
        // staking.mockStake(1 ether, 100 days);
        // vm.prank(aspen);
        // staking.mockStake(2 ether, 100 days);
        // vm.prank(taz);
        // staking.mockStake(1 ether, 100 days, alice); // Stake for alice

        // POINTS = staking.balanceOf(oak);
    }

    // Commenting out since stake & extend are disabled
