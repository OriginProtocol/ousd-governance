      ...
      <Card margin>
        <div className="bg-accent text-white -mt-10 -mx-6 p-10 md:-mx-10 text-center">
          ...
          <div className='mt-3 text-sm font-bold'>
            {`All unclaimed OGV was burned after 90 days. You can still buy OGV and stake it for up to four years. Current OGV stakers are earning a vAPY of ${stakingApy.toFixed(2)}%.`}
          </div>
          <div className='mt-6'>
            <Link
              className={"w-[15.5rem] btn rounded-full normal-case space-x-2 btn-lg h-[3.25rem] min-h-[3.25rem] bg-white border-none"}
              href="/stake"
            >
              {"Create a new stake"}
            </Link>
        ...
        <div className='-mb-10 -mx-6 p-10 md:-mx-10 text-center'>
          <div>
            <Link
              className={"w-[15.5rem] btn rounded-full normal-case space-x-2 btn-lg h-[3.25rem] min-h-[3.25rem] btn-primary border-none"}
