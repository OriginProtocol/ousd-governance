...
const LedgerDerivationContent = ({}) => {
  ...
  const errorMessageMap = (error: Error) => {
    ...
    if (
      ...
      return "Unlock your Ledger wallet and open the Ethereum application"; /*fbt(
      ...
      return "Unexpected error occurred. Please refresh page and try again." /*fbt(
  ...
  const onSelectDerivationPath = async (path, next) => {
    try {
      ...
      setDisplayError(errorMessageMap(error as Error));
      return;
    }
  ...
  return (
    <>
      <div
        ...
        className={`ledger-derivation-content flex flex-col`}
      >
        <h2>
        ...
        <div className={`paths flex flex-row`}>
          {options.map((option) => {
            return (
              <button
                key={option.path}
            ...
            <>
              {nextLoading[activePath] && (
                <img
                  ...
                  src={assetRootPath("/spinner-green-small.png")}
                />
              )}
              {!nextLoading[activePath] && (
              ...
              {!next[activePath] && !nextLoading[activePath] && (
                <button
                  className="button-arrow flex justify-center items-center"
                  onClick={() => {
                    setNextLoading({ [activePath]: true });
                ...
                >
                  <img
                    ...
                    src={assetRootPath("/arrow-down.png")}
                  />
                </button>
              )}
              {next[activePath] && !nextLoading[activePath] && (
                ...
                >
                  <img
                    className="arrow-icon"
                    src={assetRootPath("/arrow-up.png")}
                  />
                </button>
              )}
            </>
